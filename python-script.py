...
# ---- Airia Webhook ----
AIRIA_API_URL = "YOUR API LINK" #mine is not posted here for privacy
AIRIA_API_KEY = "YOU API KEY" #mine is not posted here for privacy

# Metadata
DESTINATION_HOST = "Internal-server"
DESTINATION_IP = "YOUR VICTIM IP" #mine is not posted here for privacy
...
def capture_traffic():
    ...
    capture_cmd = [
        "tshark",
        "-i", INTERFACE,
        "-f", "icmp and dst host YOUR-VICTIM-IP",  #mine is not posted here for privacy 
